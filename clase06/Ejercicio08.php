...
D. Obtener la cantidad total de todos los productos vendidos entre dos fechas. E.
Mostrar los primeros “N” números de productos que se han enviado. F. Mostrar los
nombres del usuario y los nombres de los productos de cada venta. G. Indicar el
monto (cantidad * precio) por cada una de las ventas.
...
Respuestas:
las respuestas de GDB deberían tener una primer hoja con índice indicando el archivo y
el renglón que resuelve la consigna ej:
