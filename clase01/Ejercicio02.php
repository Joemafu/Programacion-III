...
echo "Este año mi cumpleaños cae " . date("l",mktime(0,0,0,6,23,$currentyear)), "<br>";
...
echo "hoy es ", date("l \ d\ \d\\e\ M \ \d\\e\ Y"), "<br>"; //imprime lo mismo que en la linea 25 pero otro formato.
